...
function Project({ title, description, link }) {
  return (
    ...
    >
      ...
      <p className="general-site-font" style={{ margin: '0 0 16px 0', color: '#555' }}>{description}</p>
      {link && (
        <a
          className="general-site-font"
          href={link}
...
export function Projects() {
    return (
        <div className="center-content">
            ...
            <Project title="This Website!" description="Made with React, hosted by yours truly." link="https://github.com/gianpena/site" />

...
export function SpeedTyping() {
    ...
    const monkeytypeRequest60 = useCallback(async () => {
      try {
          const monkeytype_time60_response = await fetch('http://localhost:3001/monkeytype/60');
    ...
    const monkeytypeRequest15 = useCallback(async () => {
      try {
        const monkeytype_time15_response = await fetch('http://localhost:3001/monkeytype/15');
    ...
    const typeracerRequest = useCallback(async () => {
      try {
          const typeracer_response = await fetch('http://localhost:3001/typeracer');
